        ...
        <ul className="mb-4 flex flex-col gap-1">
          <li>
            ...
            >
              ...
              <span className="block antialiased  text-base leading-relaxed text-inherit font-medium capitalize">
                تیکت ها
              </span>
            </Link>
          </li>
          <li>
            ...
            >
              ...
              <span className="block antialiased  text-base leading-relaxed text-inherit capitalize">
                خروج
              </span>
            </Link>
          </li>
